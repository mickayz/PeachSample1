...
void usage(){
  ...
  printf("|----0B----|----1B----|----2B----|----3B----|\n");
  printf("---------------------------------------------\n");
  printf("| Magic 'M'| Length of DATA (LE) |  Version |\n");
  printf("|-------------------------------------------|\n");
  printf("|           SHIFTED DATA ascii              |\n");
  printf("|                  ....                     |\n");
  printf("|-------------------------------------------|\n");
  printf("|               CRC32 (LE)                  |\n");
  printf("---------------------------------------------\n");
...
int main(int argc, const char* argv[])
{
  ...
  memcpy(&dataLen, &(fileBuffer[1]), 2);
  memcpy(&version, &(fileBuffer[3]), 1);
  memcpy(&fileCRC, &(fileBuffer[fileLen-4]), 4);
  ...
  if (dataLen>fileLen-8)
  {
    dataLen = fileLen-8;
  }

  // Version must be set to 0x01
  if (version!='\x01')
  {
  ...
  // Verify CRC
  if (fileCRC != crc32(fileBuffer, fileLen-4))
  {
